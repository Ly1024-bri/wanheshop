...
<%@include file="admin_menu.jsp"%>
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            ...
            <a href="/WanhecuguiShop/manage/admin_index.jsp">首页</a>
            <span class="crumb-step">&gt;</span>
            <a class="crumb-name" href="/WanhecuguiShop/manage/admin_douserselect">顾客管理</a>
            <span class="crumb-step">&gt;</span><span>修改顾客</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="/WanhecuguiShop/manage/admin_douserupdate" method="post" id="myform" name="myform">
                    ...
                    <table class="insert-tab" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="common-text required" id="title" name="userName" size="50" value="${user.USER_ID}" type="text" readonly="readonly">
                            </td>
                        </tr>
