...
<%@include file="admin_menu.jsp"%>
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            ...
            <a class="crumb-name" href="admin_douserselect">顾客管理</a>
            <span class="crumb-step">&gt;</span><span>新增顾客</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="/WanhecuguiShop/manage/admin_douseradd" method="post" id="myform" name="myform">
