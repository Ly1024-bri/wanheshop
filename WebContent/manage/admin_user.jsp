...
<%@ include file="admin_menu.jsp" %>
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="admin_index.jsp">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">顾客管理</span></div>
        </div>
        <div class="search-wrap">
            <div class="search-content">
                <form action="/WanhecuguiShop/manage/admin_douserselect"  method="get">
                    <table class="search-tab">
                        <tr>
                            <th width="70">关键字:</th>
                            <td><input class="common-text" placeholder="姓名" name="keywords" value="${param.keywords}" id="" type="text"></td>
            ...
            <form action="/WanhecuguiShop/manage/admin_douserdel" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="admin_useradd.jsp"><i class="icon-font"></i>新增顾客</a>
                       <!--/a id="batchDel" href="javascript:delmore('你确定删除这些顾客吗？', 'myform')"><i class="icon-font"></i>批量删除</a-->
                    </div>
                </div>
                    ...
                    <table class="result-tab" width="100%">
                        ...
                        <tr>
                            ...
                            <c:if test="${u.USER_STATUS ==1 }">   
                                <a class="link-del" href="javascript:Delete('你确定要删除顾客【${u.USER_NAME}】吗？','/WanhecuguiShop/manage/admin_douserdel?id=${u.USER_ID}&cpage=${cpage}')">删除</a>
                            </c:if>    
                            </td>
                        </tr>
                       </c:forEach>
